...
public class LevelLoader {
    public static Model loadLevelModel(LevelScript levelScript) {
        Model model;
        ...
        /*
         Fixes an issue with the export from blender where the emissiveness isn't scaled by the strength set in blender (Without this the model would always be white)
